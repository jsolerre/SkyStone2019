...
@Autonomous(name="Autonomous_Foundation_Paret", group="Active")
public class Autonomous_Foundation_Paret extends LinearOpMode{
...
//        strR = hardwareMap.get(Servo.class, "str_r");
    ...
    public void foundation(boolean state){
        if(state == false){   //minimum
            ...
            founL.setPosition(0.7);
            founR.setPosition(0.3);
        }
    }
