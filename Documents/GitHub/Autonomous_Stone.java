...
@Autonomous(name="Autonomous_Stone", group="Active")
public class Autonomous_Stone extends LinearOpMode{
...
//        strR = hardwareMap.get(Servo.class, "str_r");
        ...
        if (opModeIsActive()) {
            move("r", 96, 0.6, false);
            //front intake, left, back ... rotation y deixo a foundation y torno a line? ... o em queda amb la stone a linia?
        }
    }
